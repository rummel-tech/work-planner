  ...
  group('Goal', () {
    group('Goal.create', () {
      ...
      test('sets createdAt to now when not provided', () {
        ...
        expect(
          g.createdAt.isAfter(before) || g.createdAt.isAtSameMomentAs(before),
          isTrue,
        );
        expect(
          g.createdAt.isBefore(after) || g.createdAt.isAtSameMomentAs(after),
          isTrue,
        );
      });
    ...
    group('copyWith', () {
      ...
      test('updates type', () {
        expect(
          base.copyWith(type: GoalType.farm).type,
          equals(GoalType.farm),
        );
      });
